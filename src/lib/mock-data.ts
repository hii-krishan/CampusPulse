...
export const events: Event[] = [
  ...
  },
  {
    ...
    description: 'Join the photography club for a scenic walk around campus to capture the beauty of spring.',
    date: '2025-04-19',
    time: '02:00 PM',
  ...
  {
    id: '14',
    title: 'Finals Study Marathon',
    description: 'A quiet and focused study session with free coffee and snacks to help you prep for finals.',
    date: '2025-04-22',
    time: '10:00 AM',
